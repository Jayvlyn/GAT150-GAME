...
#include <string>
#include <cassert> // same as <assert.h>
#include <fstream>
#include <iostream>
...
#define ASSESRT_LOG(condition, message)	{}
#endif // _DEBUG
...
namespace kiko 
{
	...
	{
	public:
		Logger(LogLevel logLevel = LogLevel::Info, std::ostream* ostream = &std::cout, const std::string& filename = "") :
			m_logLevel{ logLevel },
			m_ostream{ ostream } 
		{
